...
let colors = ['purple','aqua', 'fuchsia', 'azure','violet']; //untuk pieplot
...
let urlAPI = "https://api.openweathermap.org/data/2.5/weather?q=LAMPUNG&appid=f9bdf2ae8da8e9244e6e339ce1db5bde&units=metric"
let dataSheet;
let dataAPI;
let xData;
let yData;
